...
router.post('/auth/register', profileUpload.single('profilePhoto'), registerUser);
...
router.put('/users/profile/update', validateToken, profileUpload.single('profilePhoto'), updateProfile);
